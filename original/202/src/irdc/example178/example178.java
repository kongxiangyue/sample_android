package irdc.example178;

import irdc.example178.R;
...
public class example178 extends Activity
implements SurfaceHolder.Callback
{
  ...
  public void onCreate(Bundle savedInstanceState)
  {
    ...
    mSurfaceHolder01.addCallback(example178.this);
  ...
  public void mMakeTextToast(String str, boolean isLong)
  {
    if(isLong==true)
    {
      Toast.makeText(example178.this, str, Toast.LENGTH_LONG).show();
    }
    else
    {
      Toast.makeText(example178.this, str, Toast.LENGTH_SHORT).show();
    }
  }
