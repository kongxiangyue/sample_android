...
public class example172_1 extends ListActivity
{
  /* 变量声明 */
                                 ...
                                 long id)
  {
    ...
    intent.setClass(example172_1.this,example172_2.class);
  ...
  private List<News> getRss(String path)
  {
    ...
    catch (Exception e)
    {
      ...
      intent.putExtras(bundle);
      /* 错误的返回值设置为99 */
      example172_1.this.setResult(99, intent);
      example172_1.this.finish();
    }
    return data;
  }
}
