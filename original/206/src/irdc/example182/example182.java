package irdc.example182; 

import irdc.example182.R;
...
public class example182 extends Activity 
{ 
    ...
    mButton1.setOnClickListener(new Button.OnClickListener() 
    {
      ...
      public void onClick(View arg0)
      {
        ...
        strURL = mEditText1.getText().toString(); 
         ...
         Toast.makeText(example182.this, getString(R.string.str_msg)
      ...
      case (RINGTONE_PICKED):
        try
        {
          ...
          if(pickedUri!=null)
          {
            ...
            (example182.this,RingtoneManager.TYPE_RINGTONE,
                pickedUri);
          }
        }
        catch(Exception e)
