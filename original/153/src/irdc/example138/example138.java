...
public class example138 extends Activity
{
  ...
  public void onCreate(Bundle savedInstanceState)
  {
    ...
    try
    {
      ...
      if (mBundle01 != null)
      {
        ...
        if(eregi(strDelimiter1,strParam01))
        {
          ...
          /* 判断数组元素[0]是否为
           * 电话号码以及对短信关键字进行检查 */
          if(isTWCellPhone(aryTemp01[0]) && 
             eregi(strSecretWord,aryTemp01[1])
             && aryTemp01.length==2)
          {
            /* 显示已捕捉到双向短信关键字 */
            mMakeTextToast
            (
              ...
              (R.string.str_cmd_sms_catched).toString(), false
            );
            
            /* 原发送短信User的电话，亦是返回短信的电话号码 */
            String strDestAddress = aryTemp01[0];
            
            /* 测试模拟器之间是否顺利送达的Port Number */
            //String strDestAddress = "5556";
            
            /* 要返回的SMS BODY内容 */
            String strMessage = getResources().getText
            (R.string.str_cmd_sms_returned).toString();
            ...
            try
            {
              /* 创建PendingIntent作为sentIntent参数 */
              PendingIntent mPI = PendingIntent.getBroadcast
              (example138.this, 0, new Intent(), 0);
              
              /* 直接传送短信 */
              smsManager.sendTextMessage
              (strDestAddress, null, strMessage, mPI, null);
              
              /* 系统自动返回短信之后，以Toast显示结果 */
              mMakeTextToast
              (
                getResources().getText
                (R.string.str_cmd_sms_sending).toString()+
                strDestAddress,
                true
              );
            }
    ...
    mButton01.setOnClickListener(new Button.OnClickListener()
    {
      ...
      {
        // TODO Auto-generated method stub
        Intent i = new Intent( example138.this, Service1.class ); 
        i.setFlags( Intent.FLAG_ACTIVITY_NEW_TASK ); 
        startService(i);
        mMakeTextToast(getResources().getText
        (R.string.str_service_online).toString(),true);
        finish();
      }
    });
    ...
    mButton02.setOnClickListener(new Button.OnClickListener()
    {
      ...
      public void onClick(View arg0)
      {
        ...
        stopService(i);
        mMakeTextToast(getResources().getText
        (R.string.str_service_offline).toString(),true);
      }
    });
  }
  ...
  public void mMakeTextToast(String str, boolean isLong)
  {
    if(isLong==true)
    {
      Toast.makeText(example138.this, str, Toast.LENGTH_LONG).show();
    }
    else
    {
      Toast.makeText(example138.this, str, Toast.LENGTH_SHORT).show();
    }
  }
