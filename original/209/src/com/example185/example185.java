...
public class example185 extends ListActivity 
{
	/* 几个操作按钮 */
	...
	public void musicList()
	{
		...
		if (home.listFiles(new MusicFilter()).length > 0)
		{
			...
			ArrayAdapter<String> musicList = new ArrayAdapter<String>(example185.this,R.layout.musicitme, mMusicList);
