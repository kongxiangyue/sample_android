...
public class example141 extends View implements Runnable
{
	/* 声明Paint对象 */
	private Paint mPaint = null;
	
	private example141_1 mGameView2 = null;
	public example141(Context context)
	{
		super(context);
		/* 构建对象 */
		mPaint = new Paint();
		
		mGameView2 = new example141_1(context);
