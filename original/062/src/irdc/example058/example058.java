package irdc.example058;

import irdc.example058.R;
...
public class example058 extends Activity
{
  ...
  public void onCreate(Bundle savedInstanceState)
  {
    ...
    mButton01.setOnClickListener(new Button.OnClickListener()
    {
      ...
      public void onClick(View v)
      {
        ...
        (example058.this, R.layout.simple, mGames1);
    ...
    mButton02.setOnClickListener(new Button.OnClickListener()
    {
      ...
      public void onClick(View v)
      {
        ...
        aryAdapter1 = new ArrayAdapter<String>
        (example058.this, R.layout.simple, mGames2);
